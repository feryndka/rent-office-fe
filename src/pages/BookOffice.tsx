...
export default function BookOffice() {
  ...
  useEffect(() => {
    ...
    apiClient
      ...
      .then((response) => {
        ...
        const generatedUniqueCode = Math.floor(100 + Math.random() * 90000);
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    setFormData({
      ...formData,
      [e.target.name]: e.target.value, // Contoh = phone_number: 12412413
    });
  };
      ...
      >
        ...
        <div className="flex flex-col shrink-0 w-[400px] h-fit rounded-[20px] border border-[#E0DEF7] p-[30px] gap-[30px] bg-white">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col gap-[2px]">
                <div className="flex items-center gap-1">
                  <p className="font-semibold">RentOffice Fery</p>
                  <img
          ...
          <button
            ...
            className="flex items-center justify-center w-full rounded-full p-[16px_26px] gap-3 bg-[#0D903A] font-bold text-[#F7F7FD] cursor-pointer hover:shadow-md"
          >
